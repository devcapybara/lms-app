...
export const courseAPI = {
  ...
  updateCoursePublishStatus: (courseId, isPublished) => api.patch(`/courses/${courseId}/publish`, { isPublished }),
  assignStudentToCourse: (courseId, studentId) => api.post(`/courses/${courseId}/assign-student`, { studentId }),
  unassignStudentFromCourse: (courseId, studentId) => api.delete(`/courses/${courseId}/unassign-student/${studentId}`),
